# THIS ONE HANDLED THE OVERFITTING ISSUE, BUT THE EXPECTED SHORTFALL IS CALCULATED INCORRECTLY. IT IS CONSTANT PER EACH QUARTER. THE VAR IS FIXED AT 99, AND IT IS USING THE PARAMETERS FROM THE GPD, THIS RESULTS IN A MORE GENERAL EXPECTED SHORTFALL BEING CALCULATED
